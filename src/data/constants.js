...
export const Bio = {
  ...
  description:
    "Hi, I'm Muhammad Farooq Ahmad, an Automotive Engineering student at UET Lahore and a skilled 3D designer. Proficient in SolidWorks and AutoCAD, I specialize in innovative automotive component design. Passionate about blending engineering with creativity, I aim to develop efficient, sustainable transportation solutions.",
  github: "https://github.com/M-Farooq-Ahmad/",
  resume: "https://wa.me/qr/FNDMM54QQJN7P1",
  linkedin:
    "https://www.linkedin.com/in/muhammad-farooq-ahmad-32064727b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  twitter: "",
  insta: "",
  facebook: "",
};
...
export const education = [
  {
    title: "Bsc. Automotive Engineering",
    company_name: "UET Lahore",
    icon: starbucks,
    iconBg: "#383E56",
    date: "Dec 2022 - April 2026",
    points: [
      "Developing and maintaining web applications using React.js and other related technologies.",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
